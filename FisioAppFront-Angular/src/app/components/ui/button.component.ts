...
export class ButtonComponent {
  ...
  get buttonClass() {
    ...
    const variantClasses = {
      ...
      outline: 'border bg-background shadow-xs hover:bg-muted text-foreground dark:bg-input/30 dark:border-input dark:hover:bg-input/50',
  ...
  onClick(event: Event) {
    if (!this.disabled) {
      // Button behavior handled by parent
    }
  }
}
